    ...
    func configureRankingUserTVC() {
        ...
        for accumulateRanking in accumulateRankingList.matrixRankings {
            if accumulateRanking.nickname == myUserNickname {
                myRankingTVC.configureRankingCell(rankNumber: accumulateRanking.rank, profileImageURL: accumulateRanking.picturePath, nickname: accumulateRanking.nickname, blocksNumber: accumulateRanking.score)
